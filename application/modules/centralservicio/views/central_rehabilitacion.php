                ...
                <table class="table m-b-none" ui-jp="footable" data-filter="#filter" data-page-size="10">
                    ...
                    <tbody>
                       <?php foreach ($Gestion as $value) {?>
                        <?php if($value['programacion_final']=='Fecha Asignada' && $value['programacion_tratamiento']!='Tratamientos asignados' && $value['programacion_status']=='Modulo rehabilitaión para el trabajo'){?>
                        <tr id="<?=$value['derechohabiente_nss']?>">
                            ...
                            <td class="text-center">                            
                                <?php if($value['programacion_status']=='Modulo rehabilitaión para el trabajo' && $_SESSION['sess']['idRol']=='19' && $value['programacion_final']!='' && $value['programacion_tratamiento']==''){?>
                                <a href="<?=  base_url()?>centralservicio/asignartratamiento?p=<?=$value['programacion_id']?>">
