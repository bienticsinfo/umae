                ...
                <table class="table m-b-none" ui-jp="footable" data-filter="#filter" data-page-size="10">
                    ...
                    <tbody>
                       <?php foreach ($Gestion as $value) {?>
                        <?php if($value['programacion_status']=='Modulo Ortopédico' && $value['programacion_final']=='Fecha Asignada' && $value['programacion_tratamiento']!='Tratamientos asignados'){?>
                        <tr id="<?=$value['derechohabiente_nss']?>">
                            ...
                            <td class="text-center">                            
                                <?php if($value['programacion_status']=='Modulo Ortopédico' && $_SESSION['sess']['idRol']=='15' && $value['programacion_final']!='' && $value['programacion_tratamiento']==''){?>
