            ...
            <div class="panel panel-default ">
                ...
                <table class="table m-b-none" ui-jp="footable" data-filter="#filter" data-page-size="10">
                    ...
                    <tbody>
                        ...
                        <?php if($value['programacion_status']=='Tratamiento en casa'){?>
                        <tr id="<?=$value['derechohabiente_nss']?>">
                            ...
                            <td class="text-center">                            
                                <?php if($value['programacion_status']=='Tratamiento en casa' && $_SESSION['sess']['idRol']=='20'){ ?>
                                <a href="<?=  base_url()?>centralservicio/ver_folletos?p=<?=$value['programacion_id']?>">
                                    <i class="fa fa-file-pdf-o icono-accion tip" data-original-title="Ver Folletos"></i>
                                </a>&nbsp;
                                <button class="btn btn-xs back-imss btn-finalizar-tratamiento waves-effect" data-id="<?=$value['programacion_id']?>">Finalizar Tratamiento</button>
                                <?php }?>
                            </td>
                        </tr>
                        <?php } } ?>
