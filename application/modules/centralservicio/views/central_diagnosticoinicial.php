                       ...
                       <?php foreach ($Gestion as $value) {?>
                        <tr id="<?=$value['derechohabiente_nss']?>">
                            ...
                            <td class="text-center">                            
                                <i data-id-accion="modificar" data-id="<?=$value['empleado_id']?>"  data-original-title="Modificar" class="tip acciones fa fa-pencil pointer "></i>&nbsp&nbsp
                                <i data-id-accion="eliminar"  data-id="<?=$value['empleado_id']?>" data-original-title="Eliminar" class="tip acciones fa fa-trash-o pointer"></i>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
