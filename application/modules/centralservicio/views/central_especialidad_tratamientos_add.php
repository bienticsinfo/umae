    ...
    <div class="box-cell">
        <div class="panel panel-default no-border" style="background: transparent;border: transparent;margin-top: 20px">
            <ul class="breadcrumb">
                ...
                <li><a href="#" class="">Agregar Tratamiento</a></li>
            </ul>
        </div>
        ...
        <div class="box-inner padding">
            <div class="panel panel-default ">
                ...
                <div class="panel-heading p teal-900 back-imss">
                    <span style="font-size: 15px;font-weight: 500">Agregar tratamiento</span>
                ...
                <div class="panel-body b-b b-light">
                    <div class="card-body">
                        <form class="add-tratamiento">
                            <div class="row row-sm">
                                <div class="col-sm-12">
                                    <div class="md-form-group" style="margin-top: -20px">
                                        <label>Nombre del tratamiento</label>
                                        <input type="text" class="md-input" name="tratamiento_nombre" required=""> 
                                    </div>
                                    <div class="md-form-group" style="margin-top: -20px">
                                        <label>Descripción</label>
                                        <textarea class="md-input" rows="4" name="tratamiento_descripcion"> </textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <input type="hidden" name="csrf_token">
                                    <input type="hidden" name="tratamiento_id" value="">
