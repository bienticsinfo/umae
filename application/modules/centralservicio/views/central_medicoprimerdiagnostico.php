        ...
        <div class="box-inner padding">
            <div class="panel panel-default ">
                ...
                <table class="table m-b-none" ui-jp="footable" data-filter="#filter" data-page-size="10">
                    <thead>
                        <tr>
                            <th  data-sort-initial="true" data-toggle="true">N.S.S</th>
                       ...
                       <?php foreach ($Gestion as $value) {?>
                        <tr id="<?=$value['derechohabiente_nss']?>">
                            ...
                            <td class="text-center">    
                                <a href="<?=  base_url()?>assets/derechohabiente/<?=$value['derechohabiente_doc']?>" target="_blank">
                                    <i class="fa fa-file-pdf-o tip icono-accion" data-original-title="Ver Documento Anexo"></i>
                                </a>&nbsp;
                                <?php if($value['programacion_status']=='En proceso' && $_SESSION['sess']['idRol']=='13'){?>
