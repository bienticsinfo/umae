...
<html lang="en">
                            ...
                            <div class="panel panel-default ">
                                ...
                                <div class="panel-body b-b b-light">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <h1 class="text-center table-pacientes-rx-no hide" style="margin-top: calc(25%)">NO HAY LISTA DE PACIENTES </h1>
                                            <table class="table m-b-none table-hover table-pacientes-rx" style="margin-top: 0px" ui-jp="footable" data-limit-navigation="4" data-filter="#filter" data-page-size="10">
                                                <tbody></tbody>
    ...
    <script>var base_url = "<?= base_url(); ?>"</script>
        ...
        <script src="<?=  base_url()?>assets/js/os/urgencias/listas_rx.js" type="text/javascript"></script> 
