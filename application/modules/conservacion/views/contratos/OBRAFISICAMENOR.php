...
<page>
    ...
    <page_footer>
        <div style="text-align: center;font-size: 11px">
            ...
            CONTRATO OBRAS PÚBLICAS, PERSONA FISICA MENOR
        </div>
    </page_footer>
...
<page pageset="old">
    <div style="margin-top: 190px;margin-left: 20px;margin-right: 60px;line-height: 1.5;text-align: justify">
        ...
        Para la interpretación y cumplimiento de este instrumento, asi 
        como para todo aquello que no este expresamente estipulado en el mismo, las partes 
        se someten a la jurisdiccion los tribunales Federales competentes ubicados en la Ciudad de Mexico renunciando a cualquier otro fuero presente o futuro que por razon de domicilio les pudiera corresponder.Previa lectura y debidamente enteradas " Las Partes" del contenido, alcance y duerza legal del presente contrato, en virtud de quese ajusta a la expresion de su libre voluntad y que su consentimiento no se encuentra afectado por dolo, error, mala fe niotros vicios de la voluntad, lo firman y ratifican en todas sus partes, en 4 (cuatro) tantos, en 
