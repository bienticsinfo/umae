...
<page>
    <page_header>
        ...
        <div style="margin-left: 20px;margin-top: -15px">
            <b>CONTRATO OBRAS PÚBLICAS, PERSONA FISICA No. <?=$contrato[0]['contrato_numero_tmp']?></b>
        </div>
    ...
    <page_footer>
        <div style="text-align: center;font-size: 11px">
            ...
            <!--CONTRATO OBRAS PÚBLICAS, PERSONA FISICA MAYOR-->
        </div>
    </page_footer>
    <div style="margin-top: 170px;text-align: justify;margin-left: 20px;margin-right: 60px;font-family: Arial;font-weight: normal;line-height: 1.5">
        Contrato  de  obra  pública  bajo  la  condicion de pago sobre la base de precios unitarios y tiempo 
        determinado que celebran por una  parte  el Instituto  Mexicano  del  Seguro  Social, a quien  en lo sucesivo se  denominará  “EL INSTITUTO”, 
        representada en este acto por el DR. JUAN CARLOS DE LA FUENTE ZUNO  en su carácter de DIRECTOR DE LA UNIDAD 
        y la otra <?=$contrato[0]['prov_nombre']?> a quien se denominará "EL CONTRATISTA", por su propio derecho, aquienes en forma conjunta se les denominará "Las Partes"  al tenor de las declaciones y clausulas siguientes:																																																																																																				
    ...
    <div style="margin-top: 10px;margin-left: 20px;margin-right: 60px;line-height: 1.5;text-align: justify">
        ...
        <br>
        <strong>I.2.-</strong>
        Que para cubrir las erogaciones que se deriven del presente contrato, la División de Conservación aprobó el ejercicio del
        gasto corriente con fundamento en el calendario financiero del programa anual de operación autorizado
        en el presupuesto de egresos de la federación con Oficio No. <?=$contrato[0]['contrato_autorizacion_shcp']?> 
        en su sesión celebrada el <?=$contrato[0]['contrato_autorizacion_shcp_emi']?> para el ejercicio fiscal del año <?=  explode('/', $contrato[0]['contrato_fecha_inicio'])[2]?>
        <br>
        <strong>I.3.-</strong> 
        El 
        ...
        jefe de conservacion de la unidad interviene como representante Area Responsable de la Ejecución de los Trabajos.
        <br>
        <strong>I.4.-</strong>
            Que tiene la responsabilidad de mantener los inmuebles en los niveles 
            apropiados de funcionamientos para cumplir con los objetivos y acciones para los que fueron construidos.
        <br>
        <strong>I.5.-</strong>
        El inmueble ubicado en <?=$contrato[0]['hospital_inmueble_den']?> donde se ejecutarán los trabajos objeto del presente instrumento juridico, es propiedad de "El Instituto" .<br>
        <strong>I.6.-</strong> Que la adjudicación del presente contrato se realizó, por el procedimiento de contratacion por <?=$contrato[0]['contrato_tipo']?>
        ...
        <strong><p>II Declara “ EL CONTRATISTA”, que:</p></strong>
        II.1.- Tiene la capacidad juridica para contratar y obligarse en los terminos de este contrato
        <br>
        II.2.- reune las condiciones de organización, experiencia, personal capacitado y demas recursostecnicos humanos economicos necesarios y la capacidad legal suficiente para llevar a cabo los trabajos objeto del presente contrato
        <br>
...
<page pageset="old">
    ...
    <div style="text-align: justify;margin-top: 10px;margin-left: 20px;margin-right: 60px;line-height: 1.5;margin-top: 10px">
...
<page pageset="old">
    ...
    <div style="text-align: justify;margin-top: 190px;margin-left: 20px;margin-right: 60px;line-height: 1.5;">
...
<page pageset="old">
    <div style="margin-top: 190px;margin-left: 20px;margin-right: 60px;line-height: 1.5;text-align: justify">
        ...
        <br><br>
        DECIMA NOVENA.- CAUSALES DE RESCISION ADMINISTRATIVA. "Las Partes" convienen que “El Instituto” de conformidad a lo establecido por el articulo 157 del reglamento de la Ley de Obras Publicas y Servicios Relacionados con las Mismas podrá llevar a cabo la resicion administrativa del presente contrato, sin necesidad de declaracion judicial de los tribunales competentes, si el contratista incurre en cuales quiera de las siguientes causales de resicion:1Interrumpir injustificadamente los trabajos o se niegue a reparar o reponer alguna parte de ellos que hubiere sido detectada como defectuosa por "El Instituto"2No ejecute los trabajos de conformidad con lo dispuesto en este contrato y en los anexos que lo integran o sin motivo justificado no acate las órdenes dadas por el Jefe de Conservacion de Unidad o en su caso por el Supervisor de Zona3en caso de que sea declarado o sujeto a concurso mercantil en terminos de la Ley de Concursos Mercantiles o figura análoga.4Sub contrate parte de los trabajos objeto del presente contrato, sin obtener la autorizacion previa por escrito de "El Instuto".5Transfiera los derechos de cobro derivados de este instrumento juridico sin contar con autorizacion previa y por escrito de "El Instituto".6No dé a "El Instituto" y a las dependencial de gobierno que tengan facultad de intervenir, las facilñidades y datos necesarios para la inspección, vigilancia y supervisión de los materiales y trabajos.7En general, por el incumplimiento de cualesquiera de las obligaciones derivadas de este contrato, las Leyes, Tratados y demas ordenamientos que sean aplicables.
    </div>
...
<page pageset="old">
    <div style="margin-top: 190px;margin-left: 20px;margin-right: 60px;line-height: 1.5;text-align: justify">
        ...
        <br><br>
        VIGESIMA CUARTA- RESOLUCION DE CONTROVERSIAS.- Para la interpretación y cumplimiento de este 
        instrumento, asi como para todo aquello que no este expresamente estipulado en el mismo, 
        las partes se someten a la jurisdiccion los tribunales Federales competentes ubicados en la Ciudad de Mexico renunciando a cualquier otro fuero presente o futuro que por razon de domicilio les pudiera corresponder.Previa lectura y debidamente enteradas " Las Partes" del contenido, alcance y duerza legal del presente contrato, en virtud de quese ajusta a la expresion de su libre voluntad y que su consentimiento no se encuentra afectado por dolo, error, mala fe niotros vicios de la voluntad, lo firman y ratifican en todas sus partes, en 4 (cuatro) tantos, en 
