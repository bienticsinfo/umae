...
<page>
    ...
    <div style="margin-top: 160px;text-align: justify;margin-left: 20px;margin-right: 60px;font-family: Arial;font-weight: normal;line-height: 1.5">
        Contrato para la adquisicion de : <strong><?=$contrato[0]['contrato_descripcion']?></strong>
        que  celebran   por una  parte  el  Instituto Mexicano  del  Seguro  Social,  
        a través de la Unidad Médica de Alta Especialidad "Dr. Victorio de la Fuente Narváez", Distrito Federal representada en este acto por el <strong>DR. JUAN CARLOS DE LA FUENTE ZUNO </strong> en su carácter de <strong>DIRECTOR DE LA UNIDAD </strong>
    ...
    <div style="margin-top: 5px;margin-left: 20px;margin-right: 60px;line-height: 1.5;text-align: justify">
        ...
        <strong>I.4.-</strong>
            ...
            articulo <strong><?=$contrato[0]['contrato_articulo']?></strong>	
            <strong>
                <?php 
        ...
        II.1	Es una persona fisica, con actividades empresariales dedicada a :<?=$contrato[0]['prov_giro']?>	
        <br>																																																																																																		
        II.2  Su Registro Federal de Contribuyentes es: <strong style="text-transform: uppercase"><?=$contrato[0]['prov_rfc']?></strong>	
        No. De Registro Patronal ante el IMSS <strong style="text-transform: uppercase"> <?=$contrato[0]['prov_patronal_imss']?></strong>
        registro infonavit 
        ...
        Que sus trabajadores se encuentran inscritos en el regimen obligatorio del Seguro Social, y que se encuentra al corriente en el pago de las cuotas obrero patronales a que haya lugar,																																																																																																																																																																																																						
        <br>																																																																																																	
    </div>
</page>
<page pageset="old">
    <div style="margin-top: 170px;margin-left: 20px;margin-right: 60px;line-height: 1.5;text-align: justify">
         conforme a lo dispuesto en la Ley del Seguro Social. Para tal efecto, exhibe en este acto las constancias correspondientes, debidamente emitidas por "El Instituto", las  cuales se agregan al presente instrumento juridico como ANEXO  "1".
         <br>
        ...
        II.5	Manifiesta bajo protesta de decir verdad,																																																																																																			que se encuentra al corriente de sus obligaciones fiscales en los terminos que establece el
                numeral 1 de la regla 1.2.1.15, de la Resolucion Miscelanea Fiscal para el año	<?=  explode('/', $contrato[0]['contrato_fecha_inicio'])[2]?>										.																														
        <br>
        ...
        <br>
        II.7  Su domicilio para efectos del presente contrato es el ubicado en: <strong><?=$contrato[0]['prov_direccion_principal']?></strong>																																																						
