...
<page>
    <page_header>
        ...
        <div style="position: absolute;margin-left: 20px;top: 126px">
            <b>CONTRATO DE ADQUISICION PARA PERSONA MORAL No. <?=$contrato[0]['contrato_numero_tmp']?></b>
        </div>
    ...
    <page_footer>
        <div style="text-align: center;font-size: 11px">
            ...
            <!--CONTRATO DE ADQUISICION PARA PERSONA MORAL MAYOR OK-->
        </div>
    </page_footer>
    <div style="margin-top: 170px;text-align: justify;margin-left: 20px;margin-right: 60px;font-family: Arial;font-weight: normal;line-height: 1.5">
        Contrato para la adquisicion de : <?=$contrato[0]['contrato_descripcion']?>
        ...
        otra <?=$contrato[0]['prov_nombre']?>				
        en lo subsecuente “ EL PROVEEDOR”, representada por el 
        <?=$contrato[0]['prov_nombre']?> en su carácter de REPRESENTANTE LEGAL al tenor de las declaraciones y cláusulas siguientes:
        <br><br>
    </div>
...
<page pageset="old">
    <div style="margin-top: 170px;margin-left: 20px;margin-right: 60px;line-height: 1.5;text-align: justify">
        ...
        <br>
        II.7 Manifiesta bajo protesta de decir verdad, que se encuentra al corriente de sus obligaciones fiscales en los terminos que establece el numeral 1 de la regla 1.2.1.15, de la Resolucion Miscelanea Fiscal para el año <?=  explode('/', $contrato[0]['contrato_fecha_inicio'])[2]?>
        <br>
        II.8 Manifiesta bajo protesta de decir verdad, que dispone de la organización, experiencia, elementos tecnicos, humanos y economicos necesarios, asi como con la capacidad para cumplir con las obligaciones que asume en el presente contrato.
        <br>
        II.9  Su domicilio para efectos del presente contrato es el ubicado en: <?=$contrato[0]['prov_direccion_principal']?>																																																						
                Hechas las declaraciones anteriores, las partes convienen en otorgar el presente contrato de conformidad con las siguientes:	
    </div>
</page>
<page pageset="old">
    <div style="text-align: center;margin-left: 20px;margin-right: 60px;line-height: 1.5;margin-top: 170px">
