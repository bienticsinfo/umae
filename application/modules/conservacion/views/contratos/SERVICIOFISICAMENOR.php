...
<page>
    ...
    <page_footer>
        <div style="text-align: center;font-size: 11px">
            ...
            <!--CONTRATO DE SERVICIO PARA PERSONA FISICA MENOR OK-->
        </div>
    </page_footer>
...
<page pageset="old">
    <div style="margin-top: 200px;margin-left: 20px;margin-right: 60px;line-height: 1.5;text-align: justify">
        ...
        <br>
        II.4Manifiesta bajo protesta de decir verdad, no encontrarse en los supuestos de los Artículos 50 y 60 de la Ley de Adquisiciones, Arrendamientos y Servicios del Sector Público.
        <br>
