...
<page>
    ...
    <page_footer>
        <div style="text-align: center;font-size: 11px">
            ...
            <!--CONTRATO DE ADQUISICION PARA PERSONA MORAL MENOR OK-->
        </div>
    </page_footer>
    <div style="margin-top: 180px;text-align: justify;margin-left: 20px;margin-right: 60px;font-family: Arial;font-weight: normal;line-height: 1.5">
...
<page pageset="old">
    <div style="margin-top: 200px;margin-left: 20px;margin-right: 60px;line-height: 1.5;text-align: justify">																																																																																																		
        ...
        <br>
        II.3 De acuerdo con sus estatutos, su objeto social consiste entre otras actividades, en <?=$contrato[0]['prov_giro']?><br>
        II.4 Su registro Federal del Contribuyente es : <?=$contrato[0]['prov_rfc']?> 
        ...
        <br>
        II.7  Su domicilio para efectos del presente contrato es el ubicado en: <?=$contrato[0]['prov_direccion_principal']?> Hechas las declaraciones anteriores, las partes convienen en otorgar el presente contrato de conformidad con las siguientes:	
    </div>
