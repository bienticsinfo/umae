...
<page>
    <page_header>
        ...
        <div style="margin-left: 20px;margin-top: -15px">
            <b>CONTRATO DE SERVICIO PARA PERSONA FISICA No. <?=$contrato[0]['contrato_numero_tmp']?></b>
        </div>
    ...
    <page_footer>
        <div style="text-align: center;font-size: 11px">
            ...
            <!--CONTRATO DE SERVICIO PARA PERSONA FISICA MAYOR OK-->
        </div>
    </page_footer>
    <div style="margin-top: 190px;text-align: justify;margin-left: 20px;margin-right: 60px;font-family: Arial;font-weight: normal;line-height: 1.5">
        ...
        en lo subsecuente “ EL PRESTADOR DE SERVICIO”, por su propio derecho en su carácter de al tenor de las declaraciones y cláusulas siguientes:
        <br><br>
    </div>
    ...
    <div style="margin-top: 5px;margin-left: 20px;margin-right: 60px;line-height: 1.5;text-align: justify">
        ...
        I.3 Para cumplir con los programas a su cargo requiere de la prestación del servicio:
        ...
        articulo <?=$contrato[0]['contrato_articulo']?> <?php if($contrato[0]['contrato_fraccion']!=''){echo 'F'.$contrato[0]['contrato_fraccion'];}?>. de la Ley de Adquisiciones, Arrendamientos y Servicios del Sector Publico.																																																														
        <br>
...
<page pageset="old">
    <div style="margin-top: 200px;margin-left: 20px;margin-right: 60px;line-height: 1.5;text-align: justify">
        ...
        II.1
        Es una persona fisica, con actividades empresariales dedicada a: <?=$contrato[0]['prov_giro']?> , con capacidad legal para obligarse en los terminos del presente contrato
        <br>
        II.2 Su registro Federal del Contribuyente es : <span style="text-transform: uppercase"><?=$contrato[0]['prov_rfc']?></span> 
        No. De Registro Patronal ante el IMSS <span style="text-transform: uppercase"><?=$contrato[0]['prov_patronal_imss']?></span>
        registro infonavit <span style="text-transform: uppercase">
        <?php 
        ...
        <br>
        II.5	II.5Manifiesta bajo protesta de decir verdad,que se encuentra al corriente de sus obligaciones fiscales en 
