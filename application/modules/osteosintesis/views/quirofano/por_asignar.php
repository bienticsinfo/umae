               ...
               <div class="col-md-11 col-centered">
                  <div class="grid simple">
                     ...
                     <div class="grid-body no-border b-green-b-i" style="padding-top: 26px;">
                        ...
                        <table id="ver-tabla-por-asignar" class="footable" data-filter="#filter" data-page-size="10">
                           <thead>
                              <tr>
                                 ...
                                 <th data-hide="phone" data-sort-ignore="true" class="text-center">
                                    Acciones
                                 </th>
                              </tr>
                           </thead>
...
<script src="<?= base_url('assets/js/quirofano.js')?>" type="text/javascript"></script>