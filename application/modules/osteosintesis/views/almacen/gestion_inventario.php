               ...
               <div class="col-md-11 col-centered">
                  <div class="grid simple">
                     <div class="grid-title no-border b-gray" style="padding-bottom: 0;">
                        <h4 class="c-green-i">
                           <strong>Gestión de procesos</strong>
                        </h4>
                     </div>
                     <div class="grid-body no-border b-green-b-i" style="padding-top: 26px;">
                        ...
                        <table id="ver-tabla-gestion-i" class="footable" data-filter="#filter" data-page-size="10">
                           <thead>
                              <tr>
                                 <th data-toggle="true" class="text-center">Sistema de osteosíntesis</th>
