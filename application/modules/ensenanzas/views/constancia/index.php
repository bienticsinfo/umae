                    ...
                    <div class="tab-pane active  b-green-b-i" id="tab-consultar" style="padding-top:0;">
                        ...
                        <thead >
                            <tr style="text-align: center">
                              <th data-toggle="true" class="text-center">Nombre</th>
                              <th data-hide="phone">Fecha</th>
                              <th data-hide="phone">Lugar</th>
                              <th data-hide="phone">Plantilla</th>
                            ...
                            <div class="col-md-10 col-centered">
                                <div class="grid simple" style="margin:0;">
                                    ...
                                    <?= form_open(null,array('id'=>'registrar-form')); ?>
                                        ...
                                        <input type="hidden" name="jtfId" id="jtfId" value="0">
                                        ...
                                        <div class="form-group" style="margin-top:20px;">
                                            ...
                                            <div class="controls input-with-icon right input-group date" id="f-nacimiento-m" style="width:64%;">
                                                <i class="exclamation-5"></i>
                                                <input id="jtfFecha" type="text" name="jtfFecha" class="form-control" />
                                        ...
                                        <div class="form-group" style="margin-top:20px;">
                                            ...
                                            <div class="controls input-with-icon right" style="width:64%;">
                                                <i class="iconMsj"></i>
                                                <input type="text" name="jtfLugar" id="jtfLugar" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-actions b-gray">
                                            <div class="pull-right">
                                                <button id="cancelar" type="button" class="btn btn-white btn-cons-md">Calcelar</button>
...
<style>
    .accionesS,.generarEmail,.generarPdf,.infoConstania{
        cursor: pointer;
    }
</style>
</div>
<?= modules::run('menu/footer'); ?>
<script src="<?= base_url('assets/js/en_constancia.js')?>" type="text/javascript"></script>