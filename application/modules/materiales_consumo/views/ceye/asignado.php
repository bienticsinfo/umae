               ...
               <div class="col-md-11 col-centered">
                  <div class="grid simple">
                     ...
                     <div class="grid-body no-border " style="padding-top: 26px;">
                        ...
                        <table id="ver-tabla-asignado" class="footable" data-filter="#filter" data-page-size="10">
                           <thead>
                              <tr>
...
<script src="<?= base_url('assets/js/clinica-heridas/ceye.js')?>" type="text/javascript"></script>