...
class Proveedor extends Config{
    ...
    public function index(){
        ...
        $this->load->view('configuracion/proveedores/proveedores_gestion',$sql);
    }
    public function agregar() {
        $this->load->view('configuracion/proveedores/proveedores_agregar');
    }
    public function nuevoproveedor() {
        ...
        if($sql){
            echo'<script>
                    ...
                    location.href="'.  base_url().'configuracion/proveedor";
                </script>';
        }else{
            echo'<script>
