    ...
    <div class="box-cell">
        <div class="box-inner padding">
            <div class="panel panel-default">
                <div class="panel-heading back-imss">Nuevo Proveedor</div>   
                <div class="row panel-body">
                    ...
                    <div class="col-md-12 card-heading">
                        <div class="grid simple" style="margin-top: 0px">   
                        <form class="tipo_1 grid-body no-border" enctype="multipart/form-data" method="POST" action="<?=  base_url()?>configuracion/proveedor/nuevoproveedor" style="display: none">
                        ...
                        <form class="tipo_2 grid-body no-border" enctype="multipart/form-data" method="POST" action="<?=  base_url()?>configuracion/proveedor/nuevoproveedor" style="display: none">
                            <div class="row margin-top-20">
                                <div class="col-md-12 ">
                                    <input type="hidden" name="prov_tipo">
                                    <input name="csrf_token" type="hidden">
