    ...
    <div class="box-cell">
        <div class="box-inner padding">
           <ol class="breadcrumb" style="margin-top: -20px">
                ...
                <li><a href="#" class="">Graficas</a></li>
            </ol>
            <div class="col-md-6">
                <div class="panel no-border">
                    <div class="panel-body">
                        <div ui-jp="plot" ui-options="
                          [{label:'Clasificados', data: <?=$triage_clasificados?>}, {label:'No Clasificados', data: <?=$triage_noclasificados?>}],
                          {
            ...
            <div class="col-md-6">
                <div class="panel no-border">
                    <div class="panel-body">
                        <div ui-jp="plot" ui-options="
                          [{label:'Reanimación', data: <?=$triage_rojo?>}, {label:'Emergencia', data: <?=$triage_naranja?>}, {label:'Urgencia', data: <?=$triage_amarillo?>}, {label:'Urgencia Menor', data: <?=$triage_verde?>}, {label:'Sin Urgencia', data: <?=$triage_azul?>}],
                          {
                            series: { pie: { show: true, innerRadius: 0.6, stroke: { width: 3 }, label: { show: true, threshold: 0.05 } } },
